...
```{r}  
Averaged_Data <- aggregate(. ~ ID + InterpenetrationFeedback + FullyShaded, NewData, mean)
...
AVnewDF <- aggregate(. ~ ID + InterpenetrationFeedback + FullyShaded, newDF, mean)
...
Data_1st <- aggregate(. ~ ID + InterpenetrationFeedback + FullyShaded, Data_1st, mean)

Data_2nd <- aggregate(. ~ ID + InterpenetrationFeedback + FullyShaded, Data_2nd, mean)
```
